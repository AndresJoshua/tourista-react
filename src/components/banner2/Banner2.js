...
export default function Banner2() {
  ...
  return (
    <section className='banner2'>
      <button className="slide-arrow2" id="arrow-prev" onClick={() => sliderHandler(-1)} type='button'>&#8249;</button>
      <button className="slide-arrow2" id="arrow-next" onClick={() => sliderHandler(1)} type='button'>&#8250;</button>
